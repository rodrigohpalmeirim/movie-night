<script>
	export let activeTextTrack, subtitlesSize;
	let cues = [];
...
<div class="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col-reverse items-center text-slate-200 text-[40px] text-center" style:font-size="{subtitlesSize * 80}px" style:text-shadow="black 3px 3px 2px, black 0px 0px 4px">
	{#each cues as cue}
		{@html cue}
	{/each}
</div>